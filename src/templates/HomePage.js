  ...
  <main className="Home">
    ...
    <section className="section">
      <div className="container">
        ...
        <div class="Content ">
        <h1>༢༠༢༡ ལོའི་འོས་བསྡུའི་ཆེད་དུ་དྲི་བ་ཐོ་བཀོད་གནང་རོགས།</h1>
        ...
        <p><a target="_blank" class="Button" href="https://docs.google.com/forms/d/1WoCGPtE7YdQxmdXldRLRHXJtZXM6_MeDBK7FO2ZecWo/edit?usp=sharing">འགེངས་ཤོག་ཁ་འབྱེད།</a></p>
        <h2>རྣམ་དཔྱོད་ལྡན་པའི་བོད་མིའི་འོས་གང་འདྲ་སྒྲུབ་ཐུབ།</h2>
        <p>༡་ མི་དམངས་གིས་དྲི་བ་འདྲི་ནས་མཉམ་ཞུགས་བྱ།</p>
        <p>༢་ དེ་ནས་སྲིད་སྐྱོང་དང་སྤྱི་མཐུས་འོས་མི་རྣམས་ཀྱིས་དྲི་བ་ ༣༠ ལན་གདབ།</p>
        <p>༣་ བཀོལ་བདག་ (འོས་ཤོག་བླུགས་མཁན་) རྣམས་ཀྱིས་དྲ་ལྗོངས་འདིའི་ནང་དྲི་བ་དེ་དག་གཅིག་པར་ལན་གདབ།</p>
